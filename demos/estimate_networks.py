...
snafu.write_graph(nrw_graph, "nrw_graph.csv", labels=fluencydata.groupitems, subj="GROUP")
snafu.write_graph(cn_graph, "cn_graph.csv", labels=fluencydata.groupitems, subj="GROUP")
